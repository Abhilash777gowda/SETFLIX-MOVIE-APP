...
import logo from '../moviesmod.png'
function Footer() {
    return (
        <>
        <footer className="p-4 bg-white sm:p-6 dark:bg-black mt-2">
    <div className="mx-auto max-w-screen-xl">
        <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
                <a href="https://moviesmod.com" className="flex items-center">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://Moviesmod.com" className="hover:underline">Moviesmod™</a>. All Rights Reserved.
            </span>
